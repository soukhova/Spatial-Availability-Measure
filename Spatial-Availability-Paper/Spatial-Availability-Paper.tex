...
\caption{Summary description of the synthetic example: Hansen-type accessibility $S_i$, Shen-type accessibility $a_i$, and spatial availability $V_i$ with beta = 0.1 (light yellow) and beta = 0.6 (light grey).}
...
\leavevmode\vadjust pre{\hypertarget{ref-TTS2016r}{}}%
\CSLLeftMargin{50. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-soukhovGitHubRepositoryIntroducing2022}{}}%
\CSLLeftMargin{51. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-geofabrikOpenStreetMapStreetNetwork2021}{}}%
\CSLLeftMargin{69. }%
